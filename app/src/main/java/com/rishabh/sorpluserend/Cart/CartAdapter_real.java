...
public class CartAdapter_real extends RecyclerView.Adapter<CartAdapter_real.ViewHolder>
{
    onNoteClickListener onNoteClickListener;
    List<CartList> list;
    Context context;

    public CartAdapter_real(List<CartList> list, Context context, onNoteClickListener onNoteClickListener) {
        this.list = list;
    ...
    @NonNull
    @Override
    public CartAdapter_real.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CartAdapter_real.ViewHolder viewHolder, int i)
    {
